	...
	<table border="0" cellspacing="0" cellpadding="0" width="50%" >
		<tbody>
			...
			<tr>
				...
				<td width="10%"  height="50px" valign="top" ><a href="addComment.jsp">${addComment0}</a></td>
			</tr>
			...
			<tr>
				...
				<td width="10%" height="50px" valign="top" ><a href="addComment.jsp">${addComment1}</a></td>
			</tr>
			...
			<tr>
				...
				<td width="10%" height="50px" valign="top" ><a href="addComment.jsp">${addComment2}</a></td>
			</tr>
