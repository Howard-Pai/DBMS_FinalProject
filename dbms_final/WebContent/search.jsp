...
<body>
	...
	<form action="search.jsp" name="form1" >
		<input type="submit" value="正課" disable="true">
	</form >
	...
	<table border="0" cellspacing="0" cellpadding="0" width="50%" >
		<tbody>
			...
			<tr>
				<td width="10%" height="50px" valign="top" ><a href="CourseComment?courseID=${courseID0}">${courseName0}</a></td>
				...
				<td width="10%"  height="50px" valign="top" ><a href="LinkToAddComment?courseID=${courseID0}">${addComment0}</a></td>
			</tr>

			<tr>
				<td width="10%" height="50px" valign="top" ><a href="CourseComment?courseID=${courseID1}">${courseName1}</a></td>
				...
				<td width="10%" height="50px" valign="top" ><a href="LinkToAddComment?courseID=${courseID1}">${addComment1}</a></td>
			</tr>
			...
			<tr>
				...
				<td width="10%" height="50px" valign="top" ><a href="LinkToAddComment?courseID=${courseID2}">${addComment2}</a></td>
			</tr>
