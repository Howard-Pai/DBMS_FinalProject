	...
	<table border:0 cellspacing:0 cellpadding:0 width:50% >
		<tbody>
			...
			<tr>
				...
				<td width="10%"  height="50px" valign="top" ><a href="LinkToAddComment?taCourseID=${taCourseID0}&studentID=${studentID}">${addComment0}</a></td>
			</tr>
			...
			<tr>
				...
				<td width="10%"  height="50px" valign="top" ><a href="LinkToAddComment?taCourseID=${taCourseID1}&studentID=${studentID}">${addComment1}</a></td>
			</tr>
			...
			<tr>
				...
				<td width="10%"  height="50px" valign="top" ><a href="LinkToAddComment?taCourseID=${taCourseID2}&studentID=${studentID}">${addComment2}</a></td>
			</tr>
